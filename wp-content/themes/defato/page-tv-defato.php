...
<?php $cor_cat = rl_color(get_cat_ID('tv defato')); ?>
    ...
    <div class="w-container">
        <div id="box-destaque-page" class="w-col w-col-12"
             style="background: <?php echo $cor_cat ?>; color: <?php echo $cor_cat ?>;">
            <?php
            ...
            while ($the_query->have_posts()) :
                ...
                <div id="destaque-pagina" class="w-col w-col-6">
                    ...
                    <a href="<?php the_permalink() ?>"><p
                                style="filter: invert(100%);"><?php echo substr(get_the_excerpt(), 0, 250); ?></p></a>
                </div>
                <!--thumb-->
                        ...
                        <div class="w-row">
                            ...
                            <div class="galeria-video">
                                ...
                                while ($the_query->have_posts()) :
                                    ...
                                    $quebra = false;
                                    $video = 'http://www.youtube.com/watch?v=' . pegaMeioStr('embed/', '"', get_the_content());
                                    ...
                                    <a href="<?php the_permalink() ?>">
                                        ...
                                        <div class="video-list w-clearfix w-col w-col-4"
                                             onclick="link('<?php the_permalink() ?>')"
                                             style="padding: 0 10px 25px 0">
                                            <a title="<?php the_title(); ?>" class="mfp-iframe"
